...
//    public Result<SearchItemListVo<SearchItemVo>> goodsSearch(@RequestBody SearchItemDto dto, HttpServletRequest request) {
...
//    public Result<SearchFilterVo> goodsSearchFilter(@RequestBody SearchItemDto dto, HttpServletRequest request){
//        TokenInfoVo infoVo = jwtParser.getTokenInfo(request);
//        dto.setIsLogin(infoVo.getIsLogin());
//        dto.setFuid(infoVo.getFuid());
