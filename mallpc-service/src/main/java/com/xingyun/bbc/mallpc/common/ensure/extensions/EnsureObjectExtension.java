...
public class EnsureObjectExtension {
    ...
    public EnsureObjectExtension isNotNull(MallPcExceptionCode errorCode) {
        if (this.param == null) {
    ...
    public EnsureObjectExtension isEqualTo(Object param, MallPcExceptionCode errorCode) {
    ...
    public EnsureObjectExtension isNotEqualTo(Object param, MallPcExceptionCode errorCode) {
        if (param != this.param) {
            if (param != null) {
